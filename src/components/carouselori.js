...
<View style={{borderRadius: 100/2,borderWidth: 0.5,borderColor: '#eb144c',padding: 5,justifyContent: 'center',alignItems: 'center'}}>
  ...
  overflow: "hidden",
    ...
    <Text style={[gStyle.text[theme],{fontFamily: 'cairoreg',alignSelf: 'center',textAlign: 'center'}]}>{title}</Text>

  {user&&user.length>0?  <Text style={[gStyle.text[theme],{fontFamily: 'cairoreg',textAlign: 'center'}]}>{user}</Text>:null}
