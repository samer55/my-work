...
const firstcolor =first =='red'?'احمر':first =='steelblue'?'ازرق':first =='yellow'?'اصفر':'اسود'
const secondcolor =second =='red'?'احمر':second =='steelblue'?'ازرق':second =='yellow'?'اصفر':'اسود'
  ...
  return (
    ...
    >
      <View style={{ justifyContent: 'center', alignItems: 'center', flex: 1 ,flexDirection: 'column'}}>
        <MaterialCommunityIcons name={data.firstLock&data.secondlock ?'door':'door-open'} size={50} color={data.firstLock&data.secondlock ?'red':gStyle.text[theme].color} />
