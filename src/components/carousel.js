...
<View style={{borderRadius: 100/2,borderWidth: 0.5,borderColor: '#eb144c',padding: 5,justifyContent: 'center',alignItems: 'center'}}>
  ...
  {user&&user.length>0?  <Text style={[gStyle.text[theme],{fontFamily: 'ralewaysemi',textAlign: 'center'}]}>{user}</Text>:null}
  {title&&title.length>0?  <Text style={[gStyle.text[theme],{fontFamily: 'raleway',textAlign: 'center'}]}>{title}</Text>:null}
