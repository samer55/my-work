...
height: '100%'
      ...
      >
        ...
        <Text style={[gStyle.det, gStyle.text[theme],{marginVertical: 0,textAlign: 'left'}]}>{name} {arabic?'نقطة':'Points'}</Text>
...
<Text style={{color:'#eb144c',fontFamily: 'raleway'}}>{comp?arabic?'تعديل':'Edit':arabic?'اكمال':'Complete'} {arabic?'الملف الشخصي':'Profile'}</Text>
</Button>
      </View>
    </View>
  );
