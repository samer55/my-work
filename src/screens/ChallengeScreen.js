...
function notification(notkey){
  ...
  >
    ...
    <Text style={[gStyle.text[theme],  gStyle.det,{alignSelf: 'flex-end',marginHorizontal: 20,fontFamily: 'cairoreg'}]}>صاحب {data.title=='truth'?'الصراحة':'التحدي'} {navigation.state.params.data.user}</Text>
...
onPress={confirms}
  ...
  >
    <Text style={[gStyle.button,{color:'red'}]}>رفض</Text>
  </Button>
  <Button
    block
...
>
  ...
  {showreply?  <Footer style={{width: '100%',backgroundColor: gStyle.container[theme].backgroundColor}}>
      ...
      <Button iconRight block style={{width:'100%',backgroundColor: '#eb144c',justifyContent: 'center',alignItems: 'center',flexDirection: 'row'}} onPress={toggleModal}>
             ...
             <Text style={{fontFamily: 'cairoreg',fontSize: 17,color: 'white',marginHorizontal: 20}}>اضف رد</Text>
