  ...
  return (
    <ThemeContext.Consumer>
      {theme => (
        ...
        <Text style={[styles.time,{color:'#fff'}]}>Contact</Text>
        </Button>
        </View>
...
<ScrollView style={{flex:1}}   scrollEventThrottle={16}
    ...
    <ImageBackground style={{width: Dimensions.get('window').width,flex:1,height:Dimensions.get('window').height/2}} source={{uri:'https://cdn.shopify.com/s/files/1/0254/3062/2285/products/black600x600_30df6a78-3645-4ee6-9277-59e1787818c3.jpg?v=1571839897'}} >
...
<FontAwesome name={this.state.heart?'heart':'heart-o'} size={20} style={{marginRight: 10}} color={this.state.heart?'red':'#fff'}/>
</Button>
<TouchableOpacity onPress={()=>this.props.navigation.goBack()} style={{justifyContent: 'center',alignItems: 'center',padding: 7}}>
<Ionicons name='ios-more' size={25} color="#fff"/>
      ...
      {this.state.isNavBarHidden?   <View style={{position: 'relative',top:100,backgroundColor: 'white',width: Dimensions.get('window').width,paddingHorizontal: 20,borderTopLeftRadius:  9,borderTopRightRadius: 9,  shadowColor: '#000',
           shadowOpacity: 0.4,
           shadowRadius: 3,
flex:1,
...
alignSelf: 'center',
           ...
           >
<Text style={styles.Title}>Home sofa black</Text>
<View style={{flexDirection: 'row',alignItems: 'center',justifyContent: 'space-around',alignSelf: 'flex-start',marginVertical: 5}}>
<View style={{flex:1}}>
<Text style={[styles.price,{fontSize: 21}]}  numberOfLines={1}>320$</Text>
<Rating imageSize={15} readonly startingValue={4} style={[styles.rating,{alignSelf: 'flex-start'}]} />
...
<Button block style={{backgroundColor: '#eb144c',justifyContent: 'center',alignItems: 'center',padding: 20,alignSelf: 'flex-end',borderRadius: 10}}>
<Text style={[styles.time,{color:'#fff'}]}>Order Now</Text>
</Button>
</View>
</View>
...
<Text style={[styles.type]}  numberOfLines={1}>Furniture</Text>
<Text style={[styles.price,{fontFamily: 'raleway'}]}  numberOfLines={1}>April 23, 2020</Text>
          ...
          marginTop: 100,
            ...
            <Text style={gStyle.det}>Description</Text>
              ...
              <View style={styles.cards}>
              <Text style={[gStyle.det]}>Features</Text>
...
Replace old by new`}
                      ...
                      <Text style={[styles.time,{color:'#eb144c'}]}>Visit Store</Text>
                      </Button>
                      </View>
                </View>
                      </View>
