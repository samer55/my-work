...
<Modal isVisible={this.state.isModalVisible} style={{width,alignSelf: 'center'}}>
      ...
      {postStatus.length>0?<View style={{height: 50,width:Dimensions.get('window').width,backgroundColor: postStatus=='جاري الارسال..'?'green':postStatus=='تم الارسال'?'green':'red'}}>
      <Text style={[gStyle.text[theme],  gStyle.p,{alignSelf: 'flex-end',marginHorizontal: 20,fontFamily: 'cairoreg',color: '#FFF'}]}>{postStatus}</Text>
