...
onPress={this.openPanel}
    ...
    >
     <Picker.Item label={this.props.appStore.arabic?'العملة: $ USD':"Currency: $ USD"} value="key0" />
     <Picker.Item label={this.props.appStore.arabic?'العملة: JD(دينار اردني)':"Currency: JD" }value="key1" />
     <Picker.Item label={this.props.appStore.arabic?'العملة: EGP(جنيه مصري)':"Currency: EGP"} value="key2" />
     <Picker.Item label={this.props.appStore.arabic?'العملة: € EURO':"Currency: € EURO"} value="key3" />
    </Picker>
      </Form>
...
navigation.navigate('loading')
        ...
        <Icon active name="language" type="FontAwesome"/>
          ...
          navigation.navigate('loading')
              ...
              <ListItem icon Button onPress={()=>navigation.navigate('Mybusiness',{business:this.state.business})}>
                <Left>
                  <Button style={{ backgroundColor: "gray" }} onPress={()=>navigation.navigate('Mybusiness')}>
