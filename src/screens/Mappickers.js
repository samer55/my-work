...
address:'',
        ...
        dataSources: [],
        searched:[],
        dash:  props.navigation.getParam('dash',false),
...
this.getlo()
  ...
  render() {
    ...
    {/*      <Header   style={{width: width,backgroundColor: gStyle.container[theme].backgroundColor}}>
          <Left>
                   ...
                   <Body>
  <Text style={{fontFamily: 'ralewaysemi'}} numberOfLines={1}>Select location</Text>

                   </Body>
                   <Right>

                   <Button transparent onPress={()=>navigation.navigate('NewBusiness')}>
                   <Text style={{fontFamily: 'ralewaysemi',color: '#000000'}} numberOfLines={1}>Skip</Text>
  ...
  { this.state.chang?  <LocationView
        ...
        actionText={this.props.appStore.arabic?'اختار هذا الموقع':"Pick this Location"}
        onLocationSelect={(d)=>{
