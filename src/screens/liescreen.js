...
function setting(){
  ...
  >
    ...
    <Text style={[gStyle.text[theme],  gStyle.det,{alignSelf: 'flex-end',marginHorizontal: 20,fontFamily: 'cairoreg'}]}>صاحب {'الكذبات'} {navigation.state.params.data.user}</Text>
...
onPress={()=>inc('first')}
  ...
  >
    <Text style={[gStyle.button,{color:'red'}]}>اختر الاولى</Text>
  </Button>
  <Button
...
onPress={()=>inc('second')}
    style={{ justifyContent: 'center', alignItems: 'center',flex:1,marginHorizontal: 5,borderColor: '#eb144c'}}
  >
    <Text style={[gStyle.button,{color:'red'}]}>اختر الثانية</Text>
  </Button>
  <Button
...
onPress={()=>inc('third')}
    style={{ justifyContent: 'center', alignItems: 'center',flex:1,marginHorizontal: 5,borderColor: '#eb144c'}}
  >
    <Text style={[gStyle.button,{color:'red'}]}>اختر الثالثة</Text>
  </Button>
