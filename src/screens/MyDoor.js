...
function answers(){
  ...
  >
    ...
    <Text style={[gStyle.text[theme],  gStyle.det,{alignSelf: 'flex-end',marginHorizontal: 20,color:'#eb144c',fontWeight: 'bold',fontFamily: 'cairobold'}]}>انتبه: يمكنك اختيار باب واحد فقط</Text>
...
/>
<Text style={[gStyle.text[theme],  gStyle.det,{alignSelf: 'center',marginHorizontal: 20,fontWeight: 'bold',fontFamily: 'cairobold'}]}>اختر باب واحد</Text>
...
<Text style={[gStyle.text[theme],  gStyle.Title,{alignSelf: 'flex-end',marginHorizontal: 20,fontFamily: 'ralewaysemi'}]}>المرسل: {navigation.state.params.data.user}</Text>
...
<Right>
  <Text style={{fontFamily: 'cairobold'}}>{data.title=='love'?'باب الحب':'باب الصراحة'}</Text>
</Right>
</Header>
       ...
       <Text style={[gStyle.text['light'],  gStyle.Title,{alignSelf: 'flex-end',marginHorizontal: 20,color:'red'}]}>حفظ</Text>
       </TouchableOpacity>
       <Button
            block
       ...
       onPress={answer}
            ...
            >
            <Text style={[gStyle.button,{color:'#fff',fontFamily: 'cairobold'}]}>قم بالرد</Text>
            </Button>
       </View>
     </Modal>
     <Modal
     ...
     <Right>
       <Text style={{fontFamily: 'cairobold'}}>{data.title=='love'?'باب الكراهية':'باب الجرأة'}</Text>
     </Right>
     </Header>
          ...
          <Modal
                 ...
                 <View style={{flex:1,backgroundColor: 'white',width:Dimensions.get('window').width ,alignSelf: 'center',height: Dimensions.get('window').height,borderColor:'#eb144c',borderWidth: 0.3}}   collapsable={false}
                   ref={view => {
                    ...
                    {status.length>0?<View style={{height: 50,width:Dimensions.get('window').width,backgroundColor: status=='جاري النشر..'?'green':status=='تم النشر'?'green':'red'}}>
                    <Text style={[gStyle.text[theme],  gStyle.p,{alignSelf: 'flex-end',marginHorizontal: 20,fontFamily: 'cairoreg',color: '#FFF'}]}>{status}</Text>
