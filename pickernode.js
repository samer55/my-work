...
export default class RNModalPicker extends PureComponent {
  ...
  _searchFilterFunction(searchText, data) {
    let newData = [];
    let pr =this.props.arabic
    if (searchText) {
      newData = data.filter(function(item) {
        const itemData = item.name.toUpperCase();
        const itemar = item.ar.toUpperCase();

        const textData = searchText.toUpperCase();
        if (pr) {
          return itemar.includes(textData);
    ...
    return (
      ...
      >
        <View style={styles.listRowContainerStyle}>
          <Text style={this.props.pickerItemTextStyle}>{this.props.arabic?item.ar:item.name}</Text>
        </View>
      </TouchableOpacity>
    );
  }
            ...
            >
              <View>
                {this._setDefaultValue(
                  this.props.arabic?this.props.arabichold:this.props.placeHolderLabel,
                  this.props.pickerStyle,
              ...
              {this.props.showSearchBar ? (
                <View style={this.props.searchBarContainerStyle}>
                  ...
                  <TextInput
                    ...
                    placeholder={this.props.arabic?'ابحث..':this.props.searchBarPlaceHolder}
